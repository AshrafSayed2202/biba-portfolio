...
const PricingCard = ({ title, price, description, list, setIsModalOpen = () => { } }) => {
    return (
        <div className="rounded-[32px] px-[32px] py-[48px] mx-[15px] flex flex-col justify-between gap-10 shadow-[0_4px_4px_1px_rgba(26,145,185,0.20)] bg-[#ffffff0a] filter-blur-8">
            <div className="flex flex-col gap-4">
                ...
                <div>
                    <span className="text-[38px] md:text-[42px] font-[500] leading-[28px] sm:leading-[34px] md:leading-[42px]">{price === 0 ? "$0" : `$${price}`}</span>
                    <span>/month</span>
                </div>
