...
const Pricing = ({ setIsModalOpen = () => { } }) => {
    ...
    return (
        <section className='content-contain pt-[60px] sm:pt-[80px] md:pt-[100px] !max-h-none'>
            ...
            <motion.div
                ...
                transition={{ duration: 1, delay: 1.8 }}
                viewport={{ once: true }}
                className='grid grid-cols-1 sm:grid-cols-2 gap-[20px] sm:gap-[30px] md:gap-[42px] mt-[20px] sm:mt-[30px] md:mt-[40px] md:max-w-[60%] mx-auto pb-[60px] sm:pb-[80px] md:pb-[100px] relative'>
