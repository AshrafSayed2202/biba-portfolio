    ...
    return (
        <>
            <motion.nav
                ...
                viewport={{ once: true }}
                className="filter-blur-3 content-contain fixed top-5 left-0 right-0 z-50 flex h-[70px] w-full items-center justify-between p-2 bg-[rgba(255,255,255,0.05)] rounded-[16px]"
            >
                <div className="flex gap-[90px] items-center ml-[22px]">
                    <span className="text-[28px] chewy-regular">Habiba</span>
