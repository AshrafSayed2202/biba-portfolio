...
const About = () => {
    ...
    return (
        <section className='relative min-h-screen !h-auto  overflow-visible'>
            <div className='absolute w-full h-[60px] sm:h-[80px] md:h-[100px] bg-gradient-to-t from-transparent to-[#090909] top-0' />
            ...
            <div className='content-contain pt-[60px] sm:pt-[80px] md:pt-[100px] '>
                ...
                <div className='flex flex-col md:flex-row gap-5 mt-[40px] sm:mt-[60px] md:mt-[80px]'>
                    <div className='flex flex-col items-center sm:items-start gap-8 text-center sm:text-left'>
                        <motion.h3
